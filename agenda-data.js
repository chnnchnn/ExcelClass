...
//
// โครงสร้างนี้คือ Session 1 (ชม.1–3) / Session 2 (ชม.4–6) / Session 3 (ชม.7–8) พัก 15 นาที
// หลังชม.3 และชม.6 — เป็นโครงสร้างเดียวกับที่ใช้ในสไลด์ เฉลย และคู่มือผู้สอนทั้งหมด
// (ก่อนหน้านี้ไฟล์นี้เคยใช้โครงสร้าง Day 1 เช้า/บ่าย ที่พักหลังชม.2 และชม.6 ซึ่งไม่ตรงกับสไลด์
// จึงแก้กลับมาให้ตรงกัน)
